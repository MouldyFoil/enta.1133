...
{
    internal class Mace(string name = "Basic mace", string description = "A basic mace that does 5 damage", int damage = 5, int uses = 10, RarityEnum rarity = RarityEnum.uncommon) : Weapon
    {
        ...
        internal override DamageTypeEnum type { get; } = DamageTypeEnum.Bludgeoning;
